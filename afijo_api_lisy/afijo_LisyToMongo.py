    ...
    for interface_x in interfaces:
        ...
        if interface_x['OperationalState']=='Active':
            if interface_x['TypePort'] == 'DownStream':
                ...
                documento['mgt'] = interface_x['NameServiceArea']   #added
                documento['mac_domain'] = interface_x['Mac-Domain'] #added

                interface = SplitInterface(interface_x['InterfaceNamePort'],interface_x['TypePort'],interface_x['HardwareEquipment'],interface_x['GenerationModule'])      # Placa/0/Conector
                ...
                documento['up_power'] = interface_x['RxPort']
                #print("documento-comb:", documento)
                coleccion.append(documento)
                #print(coleccion)
        elif shutdown == True:
            if interface_x['Mac-Domain']  != '':
                documento['cmts'] = interface_x['NameEquipment']
                #documento['mgt'] = interface_x['NameServiceArea']
                documento['mac_domain'] = interface_x['Mac-Domain'] 
                if interface_x['TypePort'] == 'DownStream':
                    ...
                    documento['up_channel_map'] = interface_x['ChannelMapPort']
                    #documento['up_power'] = interface_x['RxPort']
                print("documento-nocomb:", documento)
                coleccion.append(documento)
