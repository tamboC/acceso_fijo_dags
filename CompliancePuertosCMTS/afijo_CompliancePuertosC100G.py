...
puertos_c100g = _auto_ansible = tecoCallAnsible(
    task_id='puertos_c100g',
    op_kwargs={
        'Equipo_ONE': '*',
        'pbook_dir': '/usr/local/airflow/dags/cel_afijo/CompliancePuertosCMTS/ansible',
        'playbook': 'afijo_PuertosC100G.yaml',
...
Compliance = _auto_ansible = tecoCallAnsible(
    ...
    op_kwargs={
        'Equipo_ONE':'*',
        'pbook_dir':'/usr/local/airflow/dags/cel_afijo/CompliancePuertosCMTS/ansible',
        'playbook':'afijo_comparC100G.yaml',
        'connection':'credenciales_equipos',
        'inventory':'/usr/local/airflow/dags/cel_afijo/inventory',
        'mock':False
    },
...
ini >> puertos_c100g >> escribomongo >> Compliance
